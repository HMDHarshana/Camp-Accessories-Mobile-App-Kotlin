...
class MainActivity : AppCompatActivity() {
    ...
    private lateinit var adapter: IteamAdapter
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        addBtn.setOnClickListener {
            val intent = Intent(this, AddIteamActivity::class.java)
    ...
    private fun loadData() {
        val iteamList = databaseHelper.getAllIteam()
        adapter = IteamAdapter(iteamList, this,userRole) { id ->
            databaseHelper.deleteIteam(id)
